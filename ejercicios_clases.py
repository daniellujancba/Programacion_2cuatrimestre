...
class Carrito_de_compras():
    ...
    def __init__(self,id_carrito,carrito_usuario,carrito_foto,carrito_curso,carrito_descripcion,carrito_precio,carrito_total,carrito_formapago,compras_cursos):
        #self.atributo = parametro_enviado
    ...
    def setid_carrito(self,id_carrito): 
        self.Id_carrito = id_carrito
